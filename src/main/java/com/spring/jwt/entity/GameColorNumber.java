...
public class GameColorNumber {
    ...
    @Column(name = "Green", nullable = false, columnDefinition = "BOOLEAN")
    private Boolean green;
    @Column(name = "Orange", nullable = false, columnDefinition = "BOOLEAN")
    private Boolean orange;
    @Column(name = "Violet", nullable = false, columnDefinition = "BOOLEAN")
